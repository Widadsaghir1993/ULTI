       ...
       // iconsLoaded.then(() => {
        ...
        store.get('profile').then(profile => {
            if (profile && profile.Token) {
                u.GetWatchList(profile.Token).then(res=>{
    ...
    _renderItem = (itm) => {
        ...
        {itm.type==0?
            <TouchableOpacity style={{
                ...
                height: 120,
                backgroundColor:'red'
            }} activeOpacity={0.6} onPress={()=>this.props.navigation.navigate('BusinessDetail',{id:itm.ID})}>
                        ...
                        <View style={{flexDirection: 'column', flex: 0.75}}>
                            ...
                            <Text
                                style={{
                                    ...
                                    width: 130,
                                    marginTop: 5,
                                }} numberOfLines={5}>{itm.description}</Text>
                        </View>
                        {/*<View style={{*/}
                        {/*flex: 0.25,*/}
                        {/*alignItems: 'center',*/}
            ...
            </TouchableOpacity>:itm.type==1? <TouchableOpacity style={{
            borderColor: '#4faadb',
            borderWidth: 1,
            borderRadius: 5,
            margin: 10,
            height: 120,
            backgroundColor:'red'
        }} activeOpacity={0.6} onPress={()=>this.props.navigation.navigate('shopDetail',{id:itm.ID})}>
                    ...
                    <View style={{flexDirection: 'column', flex: 0.75}}>
                        ...
                        <Text
                            style={{
                                ...
                                width: 130,
                                marginTop: 5,
                            }} numberOfLines={5}>{itm.address}</Text>
                    </View>
                    {/*<View style={{*/}
                    {/*flex: 0.25,*/}
                    {/*alignItems: 'center',*/}
            ...
            height: 120,
            backgroundColor:'red'
        }} activeOpacity={0.6} onPress={()=>this.props.navigation.navigate('OfferDetail',{id:itm.ID})}>
        ...
        return (
            <Drawer
                ...
                <View style={{flex: 1, backgroundColor: 'white'}}>
                    <UNavBar title="Favorites" onSearch={this.onSearchClicked} onMenu={this.onMenuClicked}/>
