...
export default class categories extends Component {
    ...
    renderRow(rowData) {
        ...
        return (
            ...
            <TouchableOpacity key={"CAT__"+rowData.ID} onPress={()=>this.props.navigation.navigate('subCategories', {id: rowData.ID,catName: rowData.name})} activeOpacity={0.5} style={{
