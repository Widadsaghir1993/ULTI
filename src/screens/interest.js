        ...
        return (
            <Drawer
                ...
                <View style={{flex: 1, backgroundColor: 'white'}}>
                    <UNavBar title="Favorites" haveBack navigation={this.props.navigation} onSearch={this.onSearchClicked} onMenu={this.onMenuClicked}/>
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <Image
                                            ...
                                            source={require('../assets/img/defaultLogo.png')}
                                            resizeMode={'cover'}
                                        />
                                    ...
                                    <View style={{flex: 1, flexDirection: 'row'}}>
                                        <View style={{flexDirection: 'column', flex: 0.75}}>
                                            ...
                                            <Text
                                                ...
                                                American multinational technology company specializing in
                                                Internet-related
                                                services and products. These include online advertising technologies,
                                                search, cloud computing, software, and hardware.</Text>
                                        </View>
                                        <View style={{
                                            flex: 0.25,
